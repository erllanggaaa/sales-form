...
<head>
    ...
    <title><?php echo $output["title"]; ?> - by Type of Application</title>
...
<body>
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">by Type of Application</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
    ...
    <div class="form-group">
        ...
        if (isset($_POST['kolom'])) {
            ...
            {
                $new="selected";
            }else if ($_POST['kolom']=="mtu"){
                $mtu="selected";
            }
        }
        ?>
            <select class="form-control col-md-3" name="kolom" required>
                <option selected disabled='disabled' value=''>Select Type of Application</option>
                <option value="new" <?php echo $new; ?> >NEW NEW</option>
                <option value="mtu" <?php echo $mtu; ?> >MTU</option>
         </select>
    </div>
    <div class="form-group">
        <input type="submit" class="btn btn-info" value="Search">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">by Type of Application</h5>
                            <div class="card-body">
      ...
      if (isset($_POST['kolom'])) {
        $kolom=trim($_POST['kolom']);
            ...
            $sql="select * from customer where application like '%".$kolom."%' order by id_customer asc";
