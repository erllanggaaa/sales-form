...
<head>
    ...
    <title><?php echo $output["title"]; ?> - DELETED CUSTOMER</title>
</head>
	    ...
	    <div class="dashboard-wrapper">
	        <div class="dashboard-influence">
	            <div class="container-fluid dashboard-content">
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Deleted Customer</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Deleted Customer</h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
      <?php
        $delcust = mysqli_query ($db, "SELECT * FROM customer WHERE status_customer='Deleted' ORDER BY id_customer DESC");
            if($delcust == false){
                  die ("Terjadi Kesalahan : ". mysqli_error($db));
                    }
                while ($hasilcust = mysqli_fetch_array ($delcust)){                            
                            ?>
                                            <tr>
