...
<head>
    ...
    <title><?php echo $output["title"]; ?> - by ZBC</title>
...
<body>
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">by ZBC</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
    ...
    <div class="form-group">
            <select class="form-control col-md-3" name="kolom" required>
                <option selected disabled='disabled' value=''>Select ZBC</option>
                <?php
        $sss="select * from zbc WHERE id_zbc";
        $hasil=mysqli_query($db,$sss);
        while ($hasildata2 = mysqli_fetch_array($hasil)) { 
            ?>
                <option value="<?php echo $hasildata2['name_zbc'];?>" ><?php echo $hasildata2['name_zbc'];?></option>
         <?php } ?>
         </select>
    </div>
    <div class="form-group">
        <input type="submit" class="btn btn-info" value="Search">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">by ZBC</h5>
                            <div class="card-body">
      ...
      if (isset($_POST['kolom'])) {
        $kolom=trim($_POST['kolom']);
            ...
            $sql="select * from customer where zbc like '%".$kolom."%' order by id_customer asc";
