...
<head>
    ...
    <title><?php echo $output["title"]; ?> - ADD PACKAGE</title>
</head>
	            ...
	            <div class="container-fluid dashboard-content">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<form action="save-tpackage.php" method="post" enctype="multipart/form-data">
                                <div class="table table-striped first">
                                <table>
                                    <thead>
                            <tr>
                            <th>Name Package<font color="red">*</font></th>
                            <th><input type="text" name="name_package" placeholder="" class="form-control" required></th>
                            </tr>
                            <tr>
