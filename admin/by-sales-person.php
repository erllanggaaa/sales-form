...
<head>
    ...
    <title><?php echo $output["title"]; ?> - by Sales Person</title>
...
<body>
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">by Sales Person</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
    ...
    <div class="form-group">
        <label for="sel1">Sales Person Name:</label>
        <?php
        $sales_person_name="";
        if (isset($_POST['sales_person_name'])) {
            $sales_person_name=$_POST['sales_person_name'];
        }
        ?>
        <input type="text" name="sales_person_name" value="<?php echo $sales_person_name;?>" class="form-control col-md-3"  required/>
    </div>
    <div class="form-group">
        <input type="submit" class="btn btn-info" value="Search">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">by Sales Person</h5>
                            <div class="card-body">
      ...
      <?php
      if (isset($_POST['sales_person_name'])) {
            $sales_person_name=trim($_POST['sales_person_name']);
            $sql="select * from customer where sales_person_name like '%".$sales_person_name."%' order by sales_person_name asc";
