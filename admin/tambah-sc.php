...
<head>
    ...
    <title><?php echo $output["title"]; ?> - ADD SALES CHANNEL</title>
</head>
	            ...
	            <div class="container-fluid dashboard-content">
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Add Sales Channel</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<form action="save-tsc.php" method="post" enctype="multipart/form-data">
                                <div class="table table-striped first">
                                <table>
                                    <thead>
                            <tr>
                            <th>Name Sales Channel<font color="red">*</font></th>
                            <th><input type="text" name="name_sales_channel" placeholder="" class="form-control" required></th>
                            </tr>
                            </thead>
                                </table>
