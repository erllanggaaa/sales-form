...
<head>
    ...
    <title><?php echo $output["title"]; ?> - DELETE CUSTOMER</title>
</head>
	            ...
	            <div class="container-fluid dashboard-content">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<form action="save-delete.php" method="post">
                    ...
                    ?><thead>
                            ...
                            <tr>
                            	<th colspan="2">Remarks Delete<font color="red">*</font></th>
                            	<th colspan="2">:&emsp;<input type="hidden" name="id_customer" value="<?=$hasil_data['id_customer'];?>" class="form-control"><textarea class="form-control" name="information_delete" required></textarea></th>
                            </tr>
                            </thead>
                                </table>
